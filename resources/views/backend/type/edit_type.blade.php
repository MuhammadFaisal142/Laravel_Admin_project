                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update.type')}}" class="form-sample" >
                                @csrf

                                <input type="text" name="id" value="{{$type->id}}" hidden>
                                    <div class="mb-3">
                                        <label for="exampleInputUsername1" class="form-label">Type Name </label>
                                        <input type="text"  name="type_name" class="form-control @error('type_name') is-invalid @enderror" value="{{$type->type_name}}" >
                                        @error('type_name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"  name="type_icon" class="form-control @error('type_icon') is-invalid @enderror"  value="{{$type->type_icon}}">
                                        @error('type_icon')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
